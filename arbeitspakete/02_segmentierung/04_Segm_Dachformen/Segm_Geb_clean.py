...
input_path = r"arbeitspakete\02_segmentierung\04_Segm_Dachformen\input\komplexe_Dachtypen_normalisiert.txt"
num_kmeans_clusters = 1000 # falls Gebàude noch zusammen, dann héher gehen
#num_reclump_clusters = 15
code = f"Seg_Dach_KMeans_{num_kmeans_clusters}_OBB_ReClump_"
