...
delta_aabb = 0.5  # Toleranz für BoundingBox-Adjazenz (Meter)
code = "XY"
...
for cid in cluster_ids:
    ...
    # Ausrichtung der OBB so, dass eine Fläche in der XY-Ebene liegt
    obb = obb.get_axis_aligned_bounding_box()  # Erzwingt XY-Planarität
    cluster_obb[cid] = obb
